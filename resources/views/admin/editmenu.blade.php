                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card">
                                    ...
                                    <form action="{{Route('vendore.update_title')}}" method="post" class="form-horizontal" id="form-horizontal">
                                        ...
                                        <div class="card-body card-block">
                                            ...
                                            <div class="row form-group" id="row">
                                                ...
                                                <div class="col col-sm-10">
                                                    ...
                                                    <input type="text" id="input-small" name="title" value="{{$data[0]->title}}" placeholder="Enter The Title " class="input-sm form-control-sm form-control">
